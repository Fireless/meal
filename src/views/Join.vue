                ...
                <v-card class="elevation-12">
                    ...
                    <v-card-text>
                        <v-form ref="form" v-model="valid" lazy-validation>
                            ...
                            <v-text-field prepend-icon="mdi-key-variant" name="password" label="Password"
                    ...
                    <v-card-actions>
                        <v-spacer></v-spacer>
                        <v-btn color="primary" :disabled="!valid" @click="submit" data-cy="joinSubmitBtn">Register</v-btn>
                    </v-card-actions>
                </v-card>
            </v-flex>
        </v-layout>
